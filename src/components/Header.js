...
const Header = () => {
  ...
  const handleScroll = () => {
    ...
    if (footer) {
      const footerRect = footer.getBoundingClientRect();
      setIsBottomNavbarVisible(footerRect.top > window.innerHeight);
    }
  };
          ...
          <ul className="hidden md:flex md:space-x-8 text-lg">
            ...
            <li>
              <a
                ...
                className="block py-2 px-4 bg-teal-500 hover:bg-teal-600 rounded-lg transition-colors duration-200"
              >
                Resume
              </a>
            </li>
          ...
          <ul className="flex justify-around items-center">
            ...
            <li className="text-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block py-1 text-sm hover:text-gray-600 flex flex-col items-center cursor-pointer"
              >
                <FiFileText className="text-lg mb-0.5" />
